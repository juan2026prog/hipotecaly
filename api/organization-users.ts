...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // --------------------------------------------------------------------------
    // 2. CAMBIAR ROL DE MIEMBRO (Server-Side Ownership Protection)
    // --------------------------------------------------------------------------
    if (action === 'change-role') {
      ...
      // Blindaje de Owner: no se puede degradar ni modificar
      ...
      // Blindaje de Auto-Escalamiento a Owner
    ...
    // --------------------------------------------------------------------------
    // 3. CAMBIAR ESTADO DE MIEMBRO (Activar / Desactivar)
    // --------------------------------------------------------------------------
