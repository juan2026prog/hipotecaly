...
export const SuperAdminTechnicalConfigPage: React.FC = () => {
  const { user } = useAuth();
  const [activeGroup, setActiveGroup] = useState<'infra' | 'security' | 'integrations' | 'diagnostic' | 'environment'>('infra');
      ...
      <div className="space-y-8 max-w-7xl mx-auto text-left">
        ...
        <div className="flex border-b border-[#152E4D] space-x-2 overflow-x-auto">
          {[
            ...
            { id: 'environment', label: 'E. Entorno y pruebas', icon: FlaskConical },
          ].map((tab) => {
            const Icon = tab.icon;
        ...
        {/* ============================================================ */}
        {/* GRUPO E: ENTORNO Y PRUEBAS (MODO PRODUCCIÓN / PRUEBA)         */}
        {/* ============================================================ */}
            ...
            <div className="bg-[#09182C] border border-[#152E4D] rounded-2xl p-6 space-y-4 shadow-md">
              <div className="flex items-center justify-between border-b border-[#152E4D] pb-3">
                ...
                <span className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded border ${
                  ...
                  {platformMode === 'production' ? '🟢 PLATAFORMA EN PRODUCCIÓN' : '🟡 PLATAFORMA EN MODO PRUEBA'}
                </span>
              </div>
            ...
            <div className="bg-[#09182C] border border-[#152E4D] rounded-2xl p-6 space-y-5 shadow-md">
              <div className="flex items-center justify-between border-b border-[#152E4D] pb-3">
                ...
                <span className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded border ${
                  ...
                  {platformMode === 'test' && testUserEnabled ? '🟢 ACTIVO' : '⚫ DESACTIVADO'}
                </span>
              </div>
              ...
              <form onSubmit={handleSaveTestUserSettings} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-300 mb-1">Usuario / Email de Prueba</label>
                    <input
                      type="email"
                      value={testUserEmail}
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex-1 bg-[#071322] border border-[#1E3E66] rounded-xl px-3 py-2 text-xs text-slate-400 font-mono tracking-widest">
                        ••••••••••••
                      </div>
                      <Button
                        type="button"
                ...
                <div className="p-4 bg-[#071322] border border-[#152E4D] rounded-xl space-y-2 text-xs text-slate-300">
                  ...
                  <ul className="space-y-1 list-disc list-inside text-slate-400 text-[11px]">
                    <li>Permite recorrer los 5 portales demo de Estudio Nova: <strong className="text-slate-300">Cliente, Inversor, Escribano, Backoffice y Tenant Admin</strong> con selector de vistas sin cambiar roles reales en base de datos.</li>
                    ...
                    <li><span className="text-amber-400 font-bold">Bloqueo en Producción:</span> Si la plataforma está en Modo Producción, el login del usuario universal queda bloqueado (HTTP 401).</li>
                  </ul>
                </div>
