        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-navy-border/60">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              Infraestructura tecnológica para el mercado de créditos con garantía hipotecaria en Uruguay: marketplace para personas y plataforma SaaS / White-Label para empresas.
            </p>
            <div className="pt-2 flex items-center space-x-2 text-xs text-slate-400">
              <ShieldCheck className="w-4 h-4 text-brand-green shrink-0" />
              <span>Aislamiento RLS & Anti-Bypass</span>
            </div>
          </div>

          {/* Col 2: Para Personas (Marketplace) */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-brand-green">Para Personas</h4>
            <ul className="space-y-2 text-xs text-slate-300">
              <li><Link to="/simulador" className="hover:text-brand-green transition-colors">Simulador de Cuotas</Link></li>
              <li><Link to="/solicitar" className="hover:text-brand-green transition-colors">Solicitar Préstamo</Link></li>
              <li><Link to="/como-funciona" className="hover:text-brand-green transition-colors">Cómo funciona</Link></li>
              <li><Link to="/prestamos" className="hover:text-brand-green transition-colors">Líneas de Préstamo</Link></li>
              <li><Link to="/preguntas-frecuentes" className="hover:text-brand-green transition-colors">Preguntas frecuentes</Link></li>
              <li><Link to="/mi-cuenta" className="hover:text-brand-green transition-colors">Portal Mi Cuenta</Link></li>
            </ul>
          </div>

          {/* Col 3: Soluciones para Empresas */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-brand-green">Soluciones B2B</h4>
            <ul className="space-y-2 text-xs text-slate-300">
              <li><Link to="/empresas/prestamistas" className="hover:text-brand-green transition-colors">Para Prestamistas Privados</Link></li>
              <li><Link to="/empresas/financieras" className="hover:text-brand-green transition-colors">Para Financieras y Fondos</Link></li>
              <li><Link to="/empresas/estudios" className="hover:text-brand-green transition-colors">Para Estudios Notariales</Link></li>
              <li>
                <Link to="/demo/nova" className="hover:text-brand-green transition-colors flex items-center space-x-1 font-semibold text-white">
                  <Sparkles className="w-3 h-3 text-brand-green" />
                  <span>Showroom NOVA White-Label</span>
                </Link>
              </li>
              <li><Link to="/contacto?demo=true" className="hover:text-brand-green transition-colors font-bold text-brand-green">Solicitar Demo B2B</Link></li>
            </ul>
          </div>

          {/* Col 4: Plataforma & SaaS */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400">Plataforma SaaS</h4>
            <ul className="space-y-2 text-xs text-slate-300">
              <li><Link to="/saas" className="hover:text-brand-green transition-colors">Visión General</Link></li>
              <li><Link to="/saas/integracion" className="hover:text-brand-green transition-colors">Integración Embebida (Widget)</Link></li>
              <li><Link to="/saas/plataforma-completa" className="hover:text-brand-green transition-colors">Plataforma Completa</Link></li>
              <li><Link to="/saas/precios" className="hover:text-brand-green transition-colors">Planes y Precios</Link></li>
              <li><Link to="/app" className="hover:text-brand-green transition-colors">Acceso Backoffice</Link></li>
            </ul>
          </div>

          {/* Col 5: Contacto & Legal */}
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400">Contacto & Legal</h4>
            <div className="space-y-2 text-xs text-slate-300">
              ...
              <div className="pt-2 space-y-1 text-slate-400">
                <div><Link to="/terminos" className="hover:text-white transition-colors">Términos del Servicio</Link></div>
                <div><Link to="/privacidad" className="hover:text-white transition-colors">Política de Privacidad</Link></div>
                <div><Link to="/seguridad" className="hover:text-white transition-colors">Seguridad de la Información</Link></div>
              </div>
            </div>
          </div>
